...
function Teams() {
  return (
    ...
    whileInView='visible'
    viewport={{ once: true }}
    className='dark:bg-slate-900 flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24
    xl:px-40 pt-30 text-gray-800 dark:text-white'>
      ...
      <div className='grid grid-cols-2 md-grid-cols-3 xl:grid-cols-4 gap-5'>
        {teamData.map((team, index)=>(
            ...
            viewport={{ once: true }}
            key={index} 
            className='flex dark:bg-slate-900 max-sm:flex-col items-center gap-5 p-4
            rounded-xl border border-gray-100 dark:border-gray-700 bg-white
            shadow-xl shadow-gray-100 dark:shadow-white/2 hover:scale-103 tansition-all duration-400'>
