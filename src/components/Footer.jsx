...
function Footer({ theme }) {
  ...
  return (
    ...
    viewport={{ once: true }}
      className="bg-slate-50 pt-10 sm:pt-20 px-4 dark:text-white dark:bg-slate-900
    ...
    >
      ...
      viewport={{ once: true }}
      className="flex justify-center text-sm text-gray-500 gap-4 flex-wrap pb-6 sm:justify-between">
        <p>Copyright 2025 ©️ Dharmendra - All Right Reserved</p>
        <div className="flex gap-2">
